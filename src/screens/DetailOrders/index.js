...
const DetailOrders = ({ route }) => {
    ...
    return (
      ...
      >
        <Block row>
          ...
          <Pressable onPress={() => navigate("PrepareOrder")}>
            <Text
              size={16}
              fontFamily={theme.fonts.fontFamily.SourceSans3Bold}
              color="#10A31E"
        ...
        {/* <Text marginTop={10}>Nhanh</Text>
        <Text marginBottom={9}>
          Giao hàng tiết kiệm (GHTK) - DHA8927489035687
        </Text> */}
        <Block marginTop={20} row alignCenter>
          <Block
            ...
            marginBottom={23}
          />
          <Block marginHorizontal={11}>
            <Text
              size={14}
              fontFamily={theme.fonts.fontFamily.SourceSans3Regular}
              color={"#10A31E"}
            >
              {"vinafarm".toUpperCase()} đang chuẩn bị hàng
            </Text>
            <Text>{moment(detail?.created_at).format("DD-MM-YYYY HH:mm")}</Text>
          </Block>
        </Block>
        <Block
          absolute
  ...
  return (
    <Block backgroundColor={theme.colors.white} flex>
      ...
      >
        <Block backgroundColor={"#DCF8E1"} row paddingVertical={32}>
          <Block flex marginLeft={20}>
            ...
            <Text
              ...
              fontFamily={theme.fonts.fontFamily.SourceSans3Regular}
            >
              Nhà cung cấp đang kiểm tra đơn hàng của bạn. Vui lòng chờ trong
              giây lát.
            </Text>
          </Block>
          <Image source={images.ic_order} style={styles.ic_order} />
        </Block>
        <Block backgroundColor={"white"} style={styles.shadow}>
          {renderInfoShip()}
        </Block>
        <Block backgroundColor={"white"} style={styles.shadow}>
          {Location()}
        ...
        <GradientButton
          ...
          style={styles.button}
          icon={<Image source={icons.ic_button} style={styles.ic_button} />}
        />
        <Button
          onPress={() => navigate("CancelScreen",{item: detail})}
